...
var file_pkg_rpc_clusters_clusters_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x02, 0x6f, 0x6b, 0x22, 0x3f, 0x0a, 0x0b, 0x48, 0x65, 0x6c, 0x6d, 0x52, 0x65,
	...
	0x73, 0x32, 0x92, 0x03, 0x0a, 0x08, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x12, 0x44,
	...
	0x73, 0x65, 0x73, 0x52, 0x65, 0x73, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x6b, 0x67, 0x2f, 0x72, 0x70,
...
var file_pkg_rpc_clusters_clusters_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_pkg_rpc_clusters_clusters_proto_goTypes = []interface{}{
	...
	(*HelmRelease)(nil),           // 14: clusters.HelmRelease
	(*ListHelmReleasesReq)(nil),   // 15: clusters.ListHelmReleasesReq
	(*ListHelmReleasesRes)(nil),   // 16: clusters.ListHelmReleasesRes
}
var file_pkg_rpc_clusters_clusters_proto_depIdxs = []int32{
	...
	14, // 6: clusters.ListHelmReleasesRes.helm_releases:type_name -> clusters.HelmRelease
	...
	12, // 10: clusters.Clusters.SyncKustomization:input_type -> clusters.SyncKustomizationReq
	15, // 11: clusters.Clusters.ListHelmReleases:input_type -> clusters.ListHelmReleasesReq
	3,  // 12: clusters.Clusters.ListContexts:output_type -> clusters.ListContextsRes
	7,  // 13: clusters.Clusters.ListKustomizations:output_type -> clusters.ListKustomizationsRes
	11, // 14: clusters.Clusters.ListSources:output_type -> clusters.ListSourcesRes
	13, // 15: clusters.Clusters.SyncKustomization:output_type -> clusters.SyncKustomizationRes
	16, // 16: clusters.Clusters.ListHelmReleases:output_type -> clusters.ListHelmReleasesRes
